window.__ModuleLoader__.load({ id: 'dsh-scifi-theme', factory: (require) => {
  ...
  '  --dsw-alias-label-primary: #e8fdff !important; --dsw-alias-label-primary-dimmed: #c0f3ff !important; --dsw-alias-label-primary-foreground: #f4ffff !important; --dsw-alias-label-primary-inverted: #001318 !important; --dsw-alias-label-primary-bluish: #8ef4ff !important;',
  '  --dsw-alias-label-secondary: #9fdfff !important; --dsw-alias-label-tertiary: #6fc0e8 !important; --dsw-alias-label-caption: #5590c8 !important; --dsw-alias-label-dimmed: #3a6ea6 !important;',
